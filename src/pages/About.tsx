        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg mx-auto">
            ...
            <div className="mb-12">
              ...
              <p className="mb-4">
                House Help Hub was founded in 2023 with a simple goal: to solve the common challenge
                of finding reliable household help. What started as a small community-based platform
