              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-brand-500 focus:border-transparent"
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    Service Providers: +1 (555) 765-4321
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    General Inquiries: info@househelpub.com<br />
                    Support: support@househelpub.com<br />
                    Careers: careers@househelpub.com
                  </p>
                </div>
